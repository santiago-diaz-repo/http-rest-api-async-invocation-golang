...
import (
	v1 "http-rest-api-versioning-golang/models/v1"
)

type newLoansManager struct{}

func NewLoansManagerV1() newLoansManager {
	return newLoansManager{}
}

func (d *newLoansManager) GetLoans() []*v1.Customer {
